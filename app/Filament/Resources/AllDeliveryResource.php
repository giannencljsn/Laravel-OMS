...
use App\Filament\Resources\AllDeliveryResource\Pages;
use App\Filament\Resources\AllDeliveryResource\RelationManagers;
...
class AllDeliveryResource extends Resource
{
    protected static ?string $model = Order::class;
    protected static ?string $modelLabel = 'All Delivery Orders';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->query(function () {
                ...
                $statuses = ['fordelivery', 'readyfordelivery'];
    ...
    {
        return [
            'index' => Pages\ListAllDeliveries::route('/'),
            'create' => Pages\CreateAllDelivery::route('/create'),
            'edit' => Pages\EditAllDelivery::route('/{record}/edit'),
        ];
    }
}
