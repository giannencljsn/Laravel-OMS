...
use App\Filament\Resources\ReadyForDeliveryResource\Pages;
use App\Filament\Resources\ReadyForDeliveryResource\RelationManagers;
...
class ReadyForDeliveryResource extends Resource
{
    protected static ?string $model = Order::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $modelLabel = 'Ready For Delivery';
        ...
        return $table
            ->query(function () {
                ...
                if (in_array($user->role, ['Store_Staff', 'Admin'])) {
                    return Order::where('status', 'readyfordelivery')
    ...
    {
        return [
            'index' => Pages\ListReadyForDeliveries::route('/'),
            'create' => Pages\CreateReadyForDelivery::route('/create'),
            'edit' => Pages\EditReadyForDelivery::route('/{record}/edit'),
        ];
    }
}
