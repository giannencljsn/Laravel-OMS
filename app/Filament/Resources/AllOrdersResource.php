...
class AllOrdersResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'All Orders(Pickup/Delivery)';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->query(function () {
                ...
                $statuses = ['fordelivery', 'readyfordelivery', 'completed', 'cancelled','forpickup','readyforpickup'];
            ...
            ->headerActions([
                ExportAction::make('export')
                    ->label('Export Orders')
                    ->authorize(fn() => in_array(Auth::user()->role, ['Superadmin', 'Admin']))//export only by Superadmin/Admin
